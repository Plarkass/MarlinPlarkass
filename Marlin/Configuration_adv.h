...
#define LCD_SHOW_E_TOTAL
  ...
  // OLIVIER #define EVENT_GCODE_SD_ABORT "G28XY"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
   ...
   */
  #define SDCARD_CONNECTION ONBOARD // OLIVIER c'etait LCD avant, test flash from octoprint
